...
> **Superseded · pre-rename copy.** The pre-rename ("Whampoa") README, kept for reference.
> Current docs: [`README.md`](../../README.md) · [`doc/build-report.md`](../build-report.md).
...
- **Build report & decisions:** [`doc/build-report.md`](../build-report.md)
- **Road-condition feature notes:** [`doc/live-layers.md`](../live-layers.md)
