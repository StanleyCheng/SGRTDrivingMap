...
const en = {
  ...
  "road.layer.traffic-speed.name": "Traffic speed segments",
  "road.layer.traffic-speed.note": "Schematic links between official monitoring endpoints",
  "road.layer.incidents.name": "Live incidents",
  "road.layer.incidents.note": "Accidents, breakdowns, obstructions and diversions",
  "road.layer.hazards.name": "Hazards & signal faults",
  "road.layer.hazards.note": "Flood alerts and faulty traffic lights",
  "road.layer.roadworks.name": "Roadworks & openings",
  "road.layer.roadworks.note": "Planned works and newly opened roads",
  ...
  "road.kind.traffic-incident": "Traffic incident",
  "road.kind.flood-alert": "Flood alert",
  "road.kind.faulty-traffic-light": "Faulty traffic light",
  "road.kind.road-work": "Roadwork",
  "road.kind.road-opening": "Road opening",
...
const zh: Record<keyof typeof en, string> = {
  ...
  "road.layer.traffic-speed.name": "交通車速路段",
  "road.layer.traffic-speed.note": "官方監測端點之間的示意連線",
  "road.layer.incidents.name": "實時事故",
  "road.layer.incidents.note": "意外、故障、障礙物及改道",
  "road.layer.hazards.name": "路面警報及交通燈故障",
  "road.layer.hazards.note": "水浸警報及交通燈故障",
  "road.layer.roadworks.name": "道路工程及通車",
  "road.layer.roadworks.note": "計劃道路工程及新通車道路",
  ...
  "road.kind.traffic-incident": "交通事故",
  "road.kind.flood-alert": "水浸警報",
  "road.kind.faulty-traffic-light": "交通燈故障",
  "road.kind.road-work": "道路工程",
  "road.kind.road-opening": "道路通車",
